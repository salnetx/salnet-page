...
const Footer = ({homepage, productspage, blogspage})=>{
    return(
        <>
          ...
          <div className="backdrop-blur-3xl text-sm border border border-2 border-neutral-200 bg-black/5 sm:rounded-3xl text-neutral-500 p-2 fixed sm:bottom-4 bottom-0 left-1/2 transform -translate-x-1/2 w-96">
          ...
          <Link href={'/'}>
          <div className={`p-3 ${homepage ? 'bg-gradient-to-b from-rose-700 to-pink-600' : 'bg-neutral-300'} rounded-2xl`}  target="_blank">
          ...
          <Link href={'/products'}>
          <div className={`p-3 ${productspage ? 'bg-gradient-to-b from-rose-700 to-pink-600' : 'bg-neutral-300'} rounded-2xl`}  target="_blank">
          ...
          <Link href={'/blogs'}>
          <div className={`p-3 ${blogspage ? 'bg-gradient-to-b from-rose-700 to-pink-600' : 'bg-neutral-300'} rounded-2xl`}  target="_blank">
